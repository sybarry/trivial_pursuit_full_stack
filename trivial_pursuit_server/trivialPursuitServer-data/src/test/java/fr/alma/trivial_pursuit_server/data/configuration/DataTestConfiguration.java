package fr.alma.trivial_pursuit_server.data.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = {"fr.alma.trivial_pursuit_server.data","fr.alma.trivial_pursuit_server.core"})
@PropertySource("data-persistance.properties")
...
public class DataTestConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("fr.alma.trivial_pursuit_server.core");
